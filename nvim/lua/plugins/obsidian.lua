return {
  ...
  --   --   local filename = path.name                          -- just the image name (no extension)
  --   --   local rel_path = "../assets/imgs/" .. path.filename -- filename with extension
  ...
  -- img_text_func = function(_, path)
  --   return string.format("![[../assets/imgs/%s]]", path.filename)
  -- end,
